(function() {
  ...
  window.app.domConfig = {
    ids: [
      ...
      'xmindCaseGenModelSelect', 'xmindCaseGenPrompt', 'xmindCaseGenReasoning', 'testXmindCaseGenModel', 'xmindCaseGenAssignStatus',
      'modelReasoningRow', 'modelReasoningEffort', 'modelReasoningHint',
